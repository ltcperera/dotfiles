...
if is_executable_not_found brew; then
...
if is_executable_not_found tmux; then
    echo "Tmux not found..."
    if is_user_response_yes; then
        brew install tmux
    fi
...
if is_executable_not_found nvim; then
...
if is_executable_not_found exa; then
...
if is_executable_not_found bat; then
...
if is_executable_not_found fzf; then
